...
router.put('/:id', authMiddleware, validateNumericParams(['id']), roleMiddleware(['admin']), productController.updateProduct);
router.delete('/:id', authMiddleware, validateNumericParams(['id']), roleMiddleware(['admin']), productController.deleteProduct);
